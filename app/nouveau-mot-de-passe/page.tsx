  ...
  return (
    <main className="mx-auto max-w-md p-8 text-gray-900">
      ...
      <form action={mettreAJourMotDePasse} className="space-y-3">
        <input name="password" type="password" placeholder="Nouveau mot de passe (10 caracteres min)" required minLength={10} className="w-full rounded border border-gray-300 bg-white p-2 text-gray-900" />
